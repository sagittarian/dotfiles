...
(define-key ara/keymap (kbd "C-c M-t") 'find-todo-work)
...
(define-key smartparens-mode-map (kbd "C-M-S-f") 'sp-forward-slurp-sexp)
(evil-define-key 'normal 'smartparens-mode-map (kbd "SPC C-f")
  'sp-forward-slurp-sexp)
(evil-define-key 'normal 'smartparens-mode-map (kbd "SPC C-b")
  'sp-forward-barf-sexp)
;; (evil-define-key 'normal 'smartparens-mode-map (kbd "SPC M-b")
;;   'sp-backward-slurp-sexp)
;; (evil-define-key 'normal 'smartparens-mode-map (kbd "SPC M-f")
